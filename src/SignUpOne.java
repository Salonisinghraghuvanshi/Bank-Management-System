...
public class SignUpOne extends JFrame implements ActionListener{
    ...
    //   String dob = ((JTextField)dateChooser.getDateEditor().getUiComponent()).getText(); //setText
      ...
      String city = cityTextField.getText(); //setText
      String pincode = pincodeTextField.getText(); //setText
      ...
      try {
          if (name.equals("")) {
              ...
              conn c = new conn();
              String query = "insert into signup values('"+formno+"','"+name+"','"+fname+"','"+gender+"','"+email+"','"+married+"','"+address+"','"+city+"','"+state+"','"+pincode+"')";
